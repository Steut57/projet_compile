...
static const char *const yytname[] =
{
  ...
  "WHILE", "THEN", "DO", "DONE", "ENDIF", "IFX", "'='", "GE", "LE", "EQ",
  "NE", "'>'", "'<'", "'+'", "'-'", "'*'", "'/'", "UNMIN", "'('", "')'",
  "'{'", "';'", "'}'", "$accept", "program", "stmtlist", "stmt",
  "condition", "tag", "tagoto", "expr", YY_NULLPTR
};
#endif
...
static const yytype_uint8 yydefact[] =
{
      ...
      15,     0,    28,    29,    30,    31,     9,     0,     0,     0,
       ...
       7,     8,    10,    11,     0,    18,    19,    21,    20,    17,
      16,    22,     2,    13,     0,    23,    12,     0,    14
};
...
#line 110 "projet.y" /* yacc.c:1646  */
    {	printf("affectation int \n");
							...
							struct symbol* lookup = symbol_lookup(&tds,(yyvsp[-3].val_str));
							if(lookup == NULL) {
								struct symbol* newID = symbol_add(&tds,(yyvsp[-3].val_str));
								newID->type=INTEGER_TYPE;
								(yyval.code_statement).code=(yyvsp[-1].code_expression).code;
								quad_add(&(yyval.code_statement).code,quad_malloc(&next_quad,_AFFECT,(yyvsp[-1].code_expression).result,NULL,newID));
							}else{								
...
#line 154 "projet.y" /* yacc.c:1646  */
    {
		...
		quad_list_complete((yyvsp[-6].code_condition).falselist, label_false);
		printf("SWAG4 \n");
		(yyval.code_statement).code = (yyvsp[-6].code_condition).code;
		quad_add(&(yyval.code_statement).code,is_true);
