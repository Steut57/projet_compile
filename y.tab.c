...
static const char *const yytname[] =
{
  ...
  "$accept", "axiom", "statement", "condition", "tag", "expr", YY_NULLPTR
};
#endif
...
#line 57 "projet.y" /* yacc.c:1646  */
    { 
                        printf("Match\n");                      
                        quad_add(&code, (yyvsp[0].codegen).code);
    }
...
#line 71 "projet.y" /* yacc.c:1646  */
    {
		...
		quad_list_complete((yyvsp[-1].code_condition).truelist,  label_true);
		quad_list_complete((yyvsp[-1].code_condition).falselist, label_false);
		
		code = (yyvsp[-1].code_condition).code;
...
#line 96 "projet.y" /* yacc.c:1646  */
    {
							...
							quad_add(&(yyval.codegen).code, quad_malloc(_PRINT,(yyvsp[-1].codegen).result,NULL,NULL));
						}
...
#line 101 "projet.y" /* yacc.c:1646  */
    {
                            ...
                            chaine->str_value=(yyvsp[-1].string);
...
#line 109 "projet.y" /* yacc.c:1646  */
    { 
		...
		quad_add(&goto_true, quad_malloc(_SUP,(yyvsp[-2].codegen).result,(yyvsp[0].codegen).result,NULL));
		quad_add(&goto_false, quad_malloc('G',NULL,NULL,NULL));
		(yyval.code_condition).code		= (yyvsp[-2].codegen).code;
		quad_add(&(yyval.code_condition).code, (yyvsp[0].codegen).code);
...
#line 122 "projet.y" /* yacc.c:1646  */
    {
		...
		quad_list_complete((yyvsp[-3].code_condition).falselist,(yyvsp[-1].codegen).result);
...
#line 164 "projet.y" /* yacc.c:1646  */
    { 	printf("expr -> expr + expr\n");
						...
						quad_add(&(yyval.codegen).code, quad_malloc(_PLUS,(yyvsp[-2].codegen).result,(yyvsp[0].codegen).result,(yyval.codegen).result));
					}
...
#line 170 "projet.y" /* yacc.c:1646  */
    {
						...
						(yyval.codegen).code	= (yyvsp[-2].codegen).code;
						quad_add(&(yyval.codegen).code,(yyvsp[0].codegen).code);
						quad_add(&(yyval.codegen).code, quad_malloc(_MOINS,(yyvsp[-2].codegen).result,(yyvsp[0].codegen).result,(yyval.codegen).result));
					}
...
#line 177 "projet.y" /* yacc.c:1646  */
    {	printf("expr -> expr * expr\n");
						...
						(yyval.codegen).code = (yyvsp[-2].codegen).code;
						quad_add(&(yyval.codegen).code,(yyvsp[0].codegen).code);
						quad_add(&(yyval.codegen).code, quad_malloc(_MUL,(yyvsp[-2].codegen).result,(yyvsp[0].codegen).result,(yyval.codegen).result));
					}
...
#line 183 "projet.y" /* yacc.c:1646  */
    {	printf("expr -> expr * expr\n");
						...
						(yyval.codegen).code = (yyvsp[-2].codegen).code;
						quad_add(&(yyval.codegen).code,(yyvsp[0].codegen).code);
						quad_add(&(yyval.codegen).code, quad_malloc(_DIV,(yyvsp[-2].codegen).result,(yyvsp[0].codegen).result,(yyval.codegen).result));
					}
